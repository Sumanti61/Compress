package com.myapp.compressfile;
...
File path=new File(Environment.getExternalStorageDirectory().getAbsolutePath() +"/myCompressor");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBaar=findViewById(R.id.seekQuality);
        ...
        seekBaar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
        ...
        btnCompress.setOnClickListener(view -> {
            int quality=seekBaar.getProgress();
            ...
            try {
                ...
                txtCompressed.setText("Size:"+Formatter.formatShortSize(MainActivity.this,finalFile.length()));
...
protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data){
    ...
    private void askPermission(){
        Dexter.withContext(this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE)
